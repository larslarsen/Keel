...
| 103 | Verify TikTok Explore, Following, and Live-room DOM interactively | Lars + reviewer | **Ready after WO-098 merge** — capture/sanitize interactive Brave DOM with Shields on, verify actual selector yield and SPA/virtualization behavior, and make selector-data corrections only; no invented fixtures and no architecture change |
